...
public class musicObject extends eventDetailsObject{
    ...
    public musicObject(int musicID, String musicType, String performerName, String warmupAct, int eventID, String eventName, String eventType, String date, String time, double eventPrice) {

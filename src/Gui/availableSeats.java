...
public class availableSeats extends javax.swing.JFrame {
    ...
    private ArrayList<Integer> getTakenSeats(ArrayList<Integer> takenSeats) {
        ...
        System.out.println("TakenSeatsmethodreached");
        System.out.println(tempSeat.getEvent());
        System.out.println(tempSeat.getStand());
        System.out.println(tempSeat.getType());
       ...
       try{
        ...
        if (valid) {
            for (int i = 0; i < seatsSelected.size(); i++) {
                ...
                String date = dateBooked.toString();
                Objects.bookingDetailsObject booking = new bookingDetailsObject(bookingID, userID, ticketID, date);
            ...
            this.dispose();
                ...
                System.out.println(e + "seat not added");
                }
    ...
    private boolean validSeats() {
        ...
        System.out.println("is seat taken method complete");
        ...
        for (int i = 0; i < userTickets.size(); i++) {
            ...
            System.out.println(ticketsBookedForEvent.get(i));
        }
        }
        ...
        valid = isSeatTaken(takenSeats, valid);
            System.out.println("seat free: "+valid);
        return valid;
    ...
    public boolean isSeatTaken(ArrayList<Integer> takenSeats, boolean valid) {
        System.out.println("isSeatTaken method started");
        for (int i = 0; i < seatsSelected.size(); i++) {

...
public class paymentChecks {
    ...
    public static boolean cardNumberCheck(String cardHolder, String cardNumber, String CVC, LocalDate expiryDate) {
        boolean valid = true;
    ...
    public static boolean CVC(boolean valid, String CVC) {
        
        String regularPattern = "^[0-9][0-9][0-9]$";
        boolean correctForm = true;
        correctForm = Pattern.compile(regularPattern).matcher(regularPattern).matches();

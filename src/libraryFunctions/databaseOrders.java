...
public class databaseOrders {
    ...
    public static boolean isAdmin(String email, String password) {
        ...
        try {
            ...
            statement.close();
            con.close();
            System.out.println("Is user an admin?" +admin);
            return admin;
        } catch (Exception e) {
            System.out.println(e);
            return false;
    ...
    public static void addMusicEvent(musicObject music) {
        try {
            ...
            Statement statement = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            String sql = "INSERT INTO app.eventTABLE VALUES (" + music.getEventID() + ", '" + music.getEventName() + "', '" + music.getEventType() + "', " + music.getEventPrice() + ", '" + music.getDate() + "', '" + music.getTime() + ")";
            statement.executeUpdate(sql);
            con.close();
        } catch (Exception e) {
            System.out.println(e);
    ...
    public static void addSportEvent(sportObject sport) {
        try {
            ...
            String sql = "INSERT INTO app.eventTABLE VALUES (" + sport.getEventID() + ", '" + sport.getEventName() + "', '" + sport.getEventType() + "', " + sport.getEventPrice() + ", '" + sport.getDate() + "', '" + sport.getTime() + ")";
            statement.executeUpdate(sql);
            con.close();
        } catch (Exception e) {
            System.out.println(e);
    ...
    public static void addSeat(seatDetailsObject seat) {
        ...
        try {
            ...
            if (rs.next() == true) {
                ...
                sql = "Insert into app.untitled values (" + seat.getSeatID() + ", "  + seat.getColumn() + ", " + seat.getStand() + ", " + seat.getPrice()+ ", "  + seat.getRow() +")";
                statement.executeUpdate(sql);
            }
            rs.close();
            con.close();
